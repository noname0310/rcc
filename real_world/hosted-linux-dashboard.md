...
| GNU coreutils `src/true` | PASS | BLOCKED | TODO | BLOCKED | BLOCKED | `tasks/16-linux-glibc-compat/23-coreutils-posix-declaration-sweep.md` |
...
| Syntax/HIR | BLOCKED | `logs/true-probe/rcc-true.stderr` now gets past `_GL_FUNCDECL_*`, `_GL_CXXALIAS_*`, and glibc `__extension__ static __inline` functions. It stops on E0071/E0083 gaps for hosted declarations/macros such as `wcwidth`, `fchownat`, unlocked stdio, and errno constants. | `tasks/16-linux-glibc-compat/23-coreutils-posix-declaration-sweep.md` |
| Object | TODO | Not attempted while Syntax/HIR is blocked. | `16-23` |
...
1. `tasks/16-linux-glibc-compat/23-coreutils-posix-declaration-sweep.md`
2. `tasks/16-linux-glibc-compat/24-coreutils-true-runtime-oracle.md`
...
but phase 16 stays open because tasks 16-23 and 16-24 are pending.
