...
/// is 34 after strict redefinition diagnostics started replacing
/// the table entry for recovery, which exposes one additional
/// same-bucket E0022 later in the fixture.
/// Task 10-18 routed ordinary `#include`
