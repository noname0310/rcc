...
| `00204` | C99 compiler bug: aggregate-rvalue member access lowering is fixed; SysV direct aggregate ABI lowering is fixed by `09-28`; aggregate `va_arg` runtime materialization remains. | `07-21`, `08-27`, `09-28`, `09-29` |
